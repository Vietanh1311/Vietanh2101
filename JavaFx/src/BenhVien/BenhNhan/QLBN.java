...
public class QLBN {
    ...
    public static void main(String[] args) {
        QLBN qlbn=new QLBN();
        qlbn.add(new BenhNhan("1","Nguyễn Viet Anh","M",2001));
        qlbn.add(new BenhNhan("2","Nguyễn Anh","M",2001));
        qlbn.add(new BenhNhan("1","Viet ANh","M",2001));
        qlbn.add(new BenhNhan("3","Trần Anh","M",2003));
        qlbn.add(new BenhNhan("4","Văn Anh","M",2004));
        qlbn.add(new BenhNhan("5","Lê Anh","M",2002));
        qlbn.add(new BenhNhan("6","Hồ Anh","M",2005));
        ...
        System.out.println("\nSửa");
        qlbn.updata(new BenhNhan("1","Nguyễn Anh","M",2001));qlbn.show();
        qlbn.updata(4);qlbn.show();

        System.out.println("Xóa");
        qlbn.remove(new BenhNhan("4","Văn Anh","M",2004));qlbn.show();
