...
//        initialize: Để khởi tạo bộ điều khiển sau khi phần tử gốc của nó đã được xử lý hoàn toàn
        qlbn.add(new BenhNhan("1","VietAnh","Nam",2001));
        qlbn.add(new BenhNhan("2","Thien","Nam",1973));
        qlbn.add(new BenhNhan("3","Huong","Nu",1976));
...
//        Check();
    ...
    void LuuFileBenhNhan(ActionEvent event) throws IOException {
        ...
        try {
            fileOutputStream=new FileOutputStream("C:\\Users\\KyThuat88\\Desktop\\Vietanh1311.github.io\\Jvcuoiki\\src\\BenhVien\\Data\\BenhNhan.txt");
    ...
    void DocFile(ActionEvent event) throws IOException {
        ...
        try{
            fileInputStream=new FileInputStream("C:\\Users\\KyThuat88\\Desktop\\Vietanh1311.github.io\\Jvcuoiki\\src\\BenhVien\\Data\\BenhNhan.txt");
